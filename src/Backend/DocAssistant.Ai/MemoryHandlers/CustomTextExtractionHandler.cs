...
public class CustomTextExtractionHandler : IPipelineStepHandler
{
        ...
        ILogger<CustomTextExtractionHandler>? log = null)
    {
        ...
        this._log = log ?? DefaultLogger<CustomTextExtractionHandler>.Instance;
        ...
        DataPipeline pipeline, CancellationToken cancellationToken = default)
    {
        ...
        foreach (DataPipeline.FileDetails uploadedFile in pipeline.Files)
        {
            ...
            UpdateSourceFileMetadata(uploadedFile.Id, uploadedFile.Name);
    ...
    public void UpdateSourceFileMetadata(string uploadedFileId, string uploadedFileName)
    {
